...
export default function RightBar() {
	return(
		<div className={'w-full overflow-hidden md:w-52'}>
			...
			<div className={'overflow-hidden shadow space-y-2 md:fixed right-1 overflow-x-auto  md:w-52 bg-white rounded-xl py-4 flex flex-col items-center justify-center'}>
