...
export default function FriendsList() {
	...
	return (
		<div className={'border-b-2 flex md:flex-col self-center w-100 sm:w-104 md:w-full overflow-x-auto md:h-100 items-center md:overflow-y-auto scrollbar-thin '}>
				{
